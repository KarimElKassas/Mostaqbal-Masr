...
class ITSelectGroupUsersScreen extends StatefulWidget {
  const ITSelectGroupUsersScreen({Key? key}) : super(key: key);

  @override
  State<ITSelectGroupUsersScreen> createState() =>
      _ITSelectGroupUsersScreenState();
}

class _ITSelectGroupUsersScreenState extends State<ITSelectGroupUsersScreen> {
