...
import 'package:mostaqbal_masr/modules/Departments/SocialMedia/chat/screens/social_input_field_widget.dart';
import 'package:mostaqbal_masr/modules/Departments/SocialMedia/chat/screens/social_user_info_screen.dart';
...
class _ConversationScreenState extends State<SocialConversationScreen> {
  ...
  Widget chatView(BuildContext context, SocialConversationCubit cubit, int index,
  ...
  Widget multipleImageMessageView(BuildContext context, SocialConversationCubit cubit,
      int index, SocialConversationStates state) {
    if (cubit.chatListReversed[index].type == "Image") {
      return Align(
...
*/
  ...
  Widget fileMessageView(SocialConversationCubit cubit, int index, SocialConversationStates state) {
  ...
  Widget audioConversationManagement(BuildContext itemBuilderContext,
      int index, SocialConversationCubit cubit) {
    return Padding(
