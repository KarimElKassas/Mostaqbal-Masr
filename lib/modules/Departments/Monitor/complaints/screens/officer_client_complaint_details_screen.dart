...
class OfficerClientComplaintDetailsScreen extends StatefulWidget {
  final String userID;
  ...
  const OfficerClientComplaintDetailsScreen(
      {Key? key,
  ...
  @override
  State<OfficerClientComplaintDetailsScreen> createState() =>
      _OfficerClientComplaintDetailsScreenState();
}

class _OfficerClientComplaintDetailsScreenState
    extends State<OfficerClientComplaintDetailsScreen> {
  ...
  Widget build(BuildContext context) {
    return BlocProvider(
      create: (context) => OfficerDisplayClientComplaintsCubit(),
      child: BlocConsumer<OfficerDisplayClientComplaintsCubit,
          OfficerDisplayClientComplaintsStates>(
        listener: (context, state) {
          ...
          if (state is OfficerDisplayClientComplaintsErrorDeleteComplaintState) {
            showToast(
                message: state.error,
                length: Toast.LENGTH_SHORT,
                gravity: ToastGravity.BOTTOM,
          ...
          if (state is OfficerDisplayClientComplaintsErrorUpdateComplaintState) {
            showToast(
                message: state.error,
                length: Toast.LENGTH_SHORT,
                gravity: ToastGravity.BOTTOM,
  ...
  Widget listItem(
      BuildContext context, OfficerDisplayClientComplaintsCubit cubit, state) {
            ...
            widget.complaintState == "false"
                ? Column(
                    children: [
                      ...
                      state is OfficerDisplayClientComplaintsLoadingUpdateComplaintState
                          ? Center(
