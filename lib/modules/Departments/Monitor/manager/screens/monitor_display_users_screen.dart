  ...
  Widget listItem(BuildContext context, MonitorManagerHomeCubit cubit, state, int index) {
    return Directionality(
      ...
      child: Card(
        ...
        child: InkWell(
          onTap: () {
            print("USER PHONE NAVIGATE : ${cubit.filteredClerksModelList[index].personPhone}\n");
              cubit.navigateTo(context, MonitorOfficerPermissionsScreen(officerID: cubit.filteredClerksModelList[index].personPhone!));
          },
          child: Padding(
